...
image: "https://static.wikia.nocookie.net/flapjack/images/e/e0/Vlcsnap-2018-08-17-13h54m39s525.png/revision/latest/scale-to-width-down/350?cb=20180817205512"
image-alt: "A cartoon apple with the word 'skooled' inside. From the Marvelous Misadventures of Flapjack, season 1, episode 5."
execute:
  echo: false
  error: false
  message: false
...
School enrollment is [falling in New Jersey](https://www.app.com/story/news/education/education-trends/2023/10/10/students-nj-public-school-enrollment-drops/70964164007/). In this post, I'll break down NJ's K-12 enrollment trends by county and school district using the NJ Department of Education's [Fall Enrollment Reports](https://www.nj.gov/education/doedata/enr/), as official a source as it gets. I'll show you *what* is happening to enrollment, but not *why* it's happening (beyond brief speculation). Answering *why* would require much more space and effort, and it's a bit beyond my pay grade.

Unfortunately, there's no single spreadsheet with data for every year, so [I made one](https://github.com/SteadyGiant/nj-schools). Feel free to use it as you please. NJ really needs to prioritize high quality public data, because its [open data site](https://data.nj.gov/) leaves a lot to be desired.
...
>
> \~ [Caitlin T.](https://responsiblehomeschooling.org/caitlin-t-s-thoughts/) \[Coalition for Responsible Home Education\]

It's interesting that we're not considering [a bill of rights for homeschool children](https://responsiblehomeschooling.org/bill-of-rights/), just one for parents. It's as if homeschooling can be abused to dominate, neglect, and abuse kids, so the state might want to provide some protection.

I can't even tell if we have any kind of children's bill of rights in NJ. The State Senate's 2008-09 session had a [bill](https://www.njleg.state.nj.us/bill-search/2008/S2334) that didn't go anywhere. These [law](https://www.camdencountydivorcelawyer.com/new-jersey-childrens-bill-rights/) [firms](https://www.gklegal.com/practices/family-law/new-jersey-children-s-bill-of-rights/) speak as if a codified law exists, but I can't find any legislation. The NJ Department of Children and Families has a [Youth Bill of Rights](https://www.nj.gov/njyrs/documents/BillofRights.pdf) for kids in the foster system, but again, no legislation. Please tell me if I'm wrong.
...
In this section, I'm going to mostly exclude the `r nrow(sd_charter)` charter schools that are considered their own school districts. When I think of a school district, I don't usually think of a single charter school. Instead, I'll display those charters' data at the end. Many vocational and special ed schools are also their own districts, but they're harder to consistently filter out. Forgive me.
...
I don't know how a school can have 2 students, but there you go.

# What To Do About It

I imagine many people will conclude from these trends that New Jersey, their county, and/or their town is too expensive for families. Since this is New Jersey, property taxes will get the most blame for our unaffordability. (And remember, property taxes affect renters, too. That's why renters also get a [property tax rebate](https://www.nj.gov/treasury/taxation/anchor/tenant.shtml).) However, I suggest also considering other factors.

If you want rising school enrollment, you need more families to move to your district. Families want adequate and affordable housing, high quality schools, and affordable day care for kids too young for school.

I'll spare you a long housing spiel. There's a nationwide housing shortage and NJ is in high demand. "Adequate" housing for a family means, to me, at least 3 bedrooms (among other things, but that's my baseline). In my experience, it's difficult to find 3-bedroom apartments or condos in high demand areas, and towns suppress the construction of 3-bedroom apartments on purpose.

Not every district in New Jersey provides public pre-school; in fact, most don't, and very few can afford to without state aid. It's up to the state government to prioritize and fund universal pre-school. Contact your state legislators about universal pre-K.
